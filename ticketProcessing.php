...
if(isset($_SESSION['nwmsg'])){
	echo '<script>alert("Please Enter Valid Show Which Is Available")</script>';
	unset($_SESSION['nwmsg']);
	$_POST['movieId'] = $_SESSION['movieId'];
}
else{
...
//movie details
							if(!isset($_POST['movieId'])) $_POST['movieId'] = $_SESSION['movieId'];
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-4 col-lg-4 " align="center">
								...
								<?php echo '"uploadimages/'.$row->image.'"';?> 
										...
										<tr>
											...
											<form action="ticketConfirmation.php" method="post" >
												...
												<tr>
													...
													<td>  
														<select name="timeSlot" class="boxStyle" required> 
												...
												<tr>
													...
													<td>
														<select name="theater" class="boxStyle" required> 
