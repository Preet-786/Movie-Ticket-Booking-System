  ...
  <div  class="panel with-nav-tabs panel-success">
    ...
    <div class="panel-body">
      <div class="tab-content">
        <div class="tab-pane fade in active" id="trailers">

          <?php 

            $res2 = $conn->query("select * from trailer;");
            $arr = array();
            while($row2=$res2->fetch_object()){
              $arr[$row2->movieName] = $row2->link;
              //echo $arr[$row2->movieName]."<br> ";
            }
                  ...
                  <div class='back'>
                    <div class='content'>
                      ...
                      <div style='margin-top: 4vw;' class='buy_ticket'>
                        <a <a href='".$movieLink."' class='btn btn-primary btn-xs btn-block'>Click to Watch trailer</a>
                      </div>
                    </div>
                  </div> <!-- end card -->
